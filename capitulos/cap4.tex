...
\begin{figure}[h!]
  ...
  \caption{Domínios de análise utilizados nos estudos revisados.}
   ...
   \includegraphics[width=0.9\textwidth]{figuras/fig_18.png}
   \fonte{Desenvolvido pelo autor.}
\end{figure}
...
Analisando os estudos, observamos que eles são limitados ao uso de dados de aceleração, velocidade e modelo QC. Sendo assim, não são exploradas todas as propriedades de dependência e não é analisado o comportamento do modelo em variações contextuais. Os resultados obtidos apresentam baixos valores das métricas de avaliação, mesmo em cenários controlados.
